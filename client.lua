	...
	while true do
                ...
                if coordonate[i] ~= nil then
                    if metrii2 <=3 then
                        ...
                        if IsControlJustPressed(1,51) then
                            ...
                            vRP.stopAnim( {false})
                            vRP.notify({"You are picking up mushrooms"})
                            ciuperci = ciuperci + 1
                                if ciuperci == 6 then
		...
		if metrii <= 3 then
            ...
            if IsControlJustPressed(1,51) then
                ...
                vRP.notify({"You've been hired!"})
                hasjob = true
                vRP.notify({"You've got the basket of Red Riding Hood"})
                ...
                elseif hasjob == true then
                    vRP.notify({"You are allready hired as Mushroom Farmer"})
                end
